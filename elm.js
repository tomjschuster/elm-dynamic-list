...
var _tomjschuster$elm_dynamic_list$Config$Config = F3(
	function (a, b, c) {
		return {width: a, xMargin: b, yMargin: c};
	});
var _tomjschuster$elm_dynamic_list$Config$default = A3(
	_tomjschuster$elm_dynamic_list$Config$Config,
	_elm_lang$core$Maybe$Just(_tomjschuster$elm_dynamic_list$Config$defaultWidth),
	_elm_lang$core$Maybe$Just(_tomjschuster$elm_dynamic_list$Config$defaultXMargin),
	_elm_lang$core$Maybe$Just(_tomjschuster$elm_dynamic_list$Config$defaultYMargin));
...
var _tomjschuster$elm_dynamic_list$Main$subscriptions = function (_p8) {
	var _p9 = _p8;
...
var _tomjschuster$elm_dynamic_list$Main$itemView = F3(
	function (config, draggedItemId, _p10) {
		var _p11 = _p10;
		var _p12 = _p11.id;
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'dragged',
								_1: A2(_tomjschuster$elm_dynamic_list$Main$compareIds, draggedItemId, _p12)
							},
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					ctor: '::',
					_0: A2(_tomjschuster$elm_dynamic_list$Main$itemStyle, config, _p11.dimensions),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onMouseDown(
							_tomjschuster$elm_dynamic_list$Main$SetDraggedItem(_p12)),
						_1: {ctor: '[]'}
					}
				}
			},
	...
	function (msg, model) {
		...
		switch (_p13.ctor) {
			...
			case 'UpdateRandomItemCount':
				var _p14 = _p13._0;
				var randomItemCount = _elm_lang$core$Native_Utils.eq(_p14, '') ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(
					A2(
						_elm_lang$core$Result$withDefault,
						12,
			...
			case 'UpdateConfig':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							config: A2(_tomjschuster$elm_dynamic_list$Config$update, _p13._0, model.config)
						}),
					_elm_lang$core$Platform_Cmd$none);
			...
			case 'SetItems':
				...
				var _p15 = A3(
					...
					{
						ctor: '_Tuple2',
						_0: _elm_lang$core$List$length(_p19),
						_1: {ctor: '[]'}
					},
					_p19);
				var items = _p15._1;
			...
			case 'SetDraggedItem':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							draggedItemId: _elm_lang$core$Maybe$Just(_p13._0)
						}),
					_elm_lang$core$Platform_Cmd$none);
			default:
				return A2(
...
if (typeof _tomjschuster$elm_dynamic_list$Main$main !== 'undefined') {
    _tomjschuster$elm_dynamic_list$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"UpdateRandomItemCount":["String"],"ClearItems":[],"ClearDraggedItem":["Mouse.Position"],"SetItems":["List (Int -> Main.Item)"],"GenerateRandomItem":[],"UpdateConfig":["Config.Msg"],"NoOp":[],"SetDraggedItem":["Int"]}},"Config.Msg":{"args":[],"tags":{"UpdateXMargin":["String"],"UpdateWidth":["String"],"UpdateYMargin":["String"],"NoOp":[]}}},"aliases":{"Main.Dimensions":{"args":[],"type":"{ height : Float, width : Float }"},"Mouse.Position":{"args":[],"type":"{ x : Int, y : Int }"},"Main.Item":{"args":[],"type":"{ dimensions : Main.Dimensions, id : Int }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
